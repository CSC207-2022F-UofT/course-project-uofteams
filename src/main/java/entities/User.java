...
public class User {
    ...
    * */
    ...
    public User(boolean admin, int id, String email, String password, ArrayList<Integer> posts,
    ...
    * */
    public boolean removeUserFavourite(Post toRemove) {
        for (int i = 0; i < this.favourites.size(); i++) {
            if (this.favourites.get(i).equals(toRemove.getID())) {
    ...
    * */
    public boolean removeUserPost(Post toRemove) {
        ...
        for (int i = 0; i < this.posts.size(); i++) {
            if (this.posts.get(i).equals(toRemove.getID())) {
                this.posts.remove(i);
                return true;
            }
        }
